...
import { FloorMapWorkSetWithMaterialsType, WorkSetCheckGroupWithMaterialsType, WorkSetMaterialType } from '@/components/main/types';
            ...
            {isExpanded && (
              <View style={styles.groupContent}>
                {group.work_sets.map((workSet) => (
                  <WorkSetItem key={workSet.work_set_id + '-' + workSet.material_id} workSet={workSet} />
                ))}
              </View>
            )}
          </View>
